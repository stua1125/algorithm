...
public class Example_contentsSearch {

	public static void main(String[] args) throws IOException {
		URL url = new URL("https://dev.comet.duzon.net/api/HR/GroupWareConnection/contentsSearch");
        ...
        params.put("athz_rpts_cd", "MA2019121608888");
        params.put("form_id", "X98");
